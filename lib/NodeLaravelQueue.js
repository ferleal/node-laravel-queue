    ...
    value: function redisPop() {
      ...
      var pop = function pop() {
        _this2.client.blpop(_this2.appname + _this2.prefix + 'queues:' + _this2.queue, 60000, function (err, replay) {
          ...
          if ((replay === null || replay === void 0 ? void 0 : replay[1]) == undefined) {
            _this2.winston.error("Queue: ".concat(_this2.appname + _this2.prefix + 'queues:' + _this2.queue, ". Error node-laravel-queue Empty Redis info : ").concat(replay));
